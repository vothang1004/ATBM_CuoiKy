	...
	<%@ include file="/common/taglibs.jsp" %>
		...
		<div class="grid wide">
			...
			<div class="new-product">
				<div class="grid wide">
					<a href="${pageContext.request.contextPath}/allproduct?type=new" class="new-product__title">mẫu mới
						về</a>
					<div class="row">
						<c:forEach items="${listTop4NewProduct}" var="p">
							<div class="col-3">
								<div class="product <c:if test=" ${p.salePercent ne 0}">product--sale</c:if>">
									...
									<div class="view-more">
										<a href="${pageContext.request.contextPath}/allproduct?type=new"
											class="view-more__link">Xem thêm
									...
									<form data-id='${p.id}' action="pay" method="post"
										class="hide-on-taplet product__size">
										<div class="product__size-wrap">
											<input checked class="product__size-option" hidden type="radio" value='S'
												name="size${p.id}" id="s${p.id}">
											<label for="s${p.id}" class="product__size-label">S</label>
											<input class="product__size-option" hidden type="radio" value='M'
												name="size${p.id}" id="m${p.id}">
											<label for="m${p.id}" class="product__size-label">M</label>
											<input class="product__size-option" hidden type="radio" value='L'
												name="size${p.id}" id="l${p.id}">
										...
										<div class="product__action">
											<div class="product__action-wrap">
												<div class="product__price">
													<c:choose>
														<c:when test="${p.salePercent ne 0}">
															<span class="product__price-sell">${p.priceSaleFormat}
																đ</span>
														</c:when>
														<c:otherwise>
												...
												<div class="product__action-option">
													<button title="Thêm vào yêu thích" onclick="handleLike.bind(this)()"
														data-id='${p.id}' class="btn-action prouct__action-like">
														<i class="far fa-heart"></i>
													</button>
													<button title="Thêm vào giỏ hàng" onclick="handleCart.bind(this)()"
														data-id='${p.id}' class="btn-action product__action-cart">
														<i class="fas fa-shopping-basket"></i>
													</button>
													<button onclick='handleBuy.bind(this)()' data-id='${p.id}'
														class="btn-action product__action-buy">
					...
					<div class="banner__container">
						<div class="banner__container-column">
							<div class="banner__container-column-left">
								<img class="banner banner1" src="./assets/image/banner1.webp" alt="">
							</div>
						</div>
						<div class="banner__container-column ">
								...
								<div class="banner__container-row-over">
									<div class="banner__container-row banner__container-row-right">
										<div class="banner__container-row-column">
											<img class="banner banner2" src="./assets/image/banner2.webp" alt="">
										</div>
										<div class="banner__container-row-column">
											<img class="banner banner3" src="./assets/image/banner3.webp" alt="">
										</div>
									</div>
								</div>
								<div class="banner__container-row-under">
									<img class="banner banner4" src="./assets/image/banner4.webp" alt="">
								</div>
							</div>
						</div>
					</div>
								...
								<form data-id='1' action="" method="get" class="hide-on-taplet product__size">
									<div class="product__color">
										<input class="product__color-option" hidden type="radio" name="color"
											id="yellow"> <label for="yellow" class="product__color-label"> <img
										...
										</label> <input class="product__color-option" hidden type="radio" name="color"
											id="red"> <label for="red" class="product__color-label"> <img
												src="https://bizweb.dktcdn.net/thumb/large/100/434/926/products/pc-ao-dam-2019-large-1605601954-6629.jpg?v=1629002946000"
												alt="" class="product__color-img">
										</label>
									</div>
									<div class="product__size-wrap">
										<input class="product__size-option" hidden type="radio" name="size" id="s">
										<label for="s" class="product__size-label">S</label> <input
											class="product__size-option" hidden type="radio" name="size" id="m"> <label
											for="m" class="product__size-label">M</label>
										<input class="product__size-option" hidden type="radio" name="size" id="l">
										...
										<form data-id='1' action="" method="get" class="product__size">
											...
											<div class="product__size-wrap">
												<input class="product__size-option" hidden type="radio" name="size"
													id="s"> <label for="s" class="product__size-label">S</label> <input
													class="product__size-option" hidden type="radio" name="size" id="m">
												<label for="m" class="product__size-label">M</label>
												<input class="product__size-option" hidden type="radio" name="size"
													id="l"> <label for="l" class="product__size-label">L</label>
											</div>
										</form>
									</a>
									<div class="product__info">
			...
			<div class="grid wide">
				...
				<div class="row">
					<div class="col l-6 m-12 c-12 min-12">
						<div class="news-left">
							<img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8ZmFzaGlvbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
								alt="" class="news-left__img">
							<div class="news-left__belong">
								<span class="news-left__date">15/08/2021</span> <span class="news-left__author">- bởi:
									Ego Creative</span>
							</div>
							...
							<div class="news-right__item">
								<div class="row">
									<div class="col l-4 m-4 c-4 min-4">
										<img src="https://bizweb.dktcdn.net/100/434/926/articles/image001a.jpg?v=1629005966930"

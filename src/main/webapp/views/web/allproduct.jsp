<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ include file="/common/taglibs.jsp" %>
                    ...
                    <div class="sidebar">
                                            ...
                                            <c:forEach items="${listSubCategory}" var="subcate">
                                                <c:if test="${subcate.categoryId eq cate.id}">
                                                    <li class="sidebar__category-sublist__sublist-item">
                                                        <a href=""
                                                            class="sidebar__category-sublist__sublist-link">${subcate.name}</a>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
                                        </ul>
                        ...
                        <div class="sidebar__filter">
                            ...
                            <div class="sidebar__filter-price">
                                ...
                                <div class="sidebar__filter__choose">
                                    <input class="sidebar__filter-input" hidden value='0-99000' type="radio" id="price2"
                                        name="price">
                                ...
                                <div class="sidebar__filter__choose">
                                    <input class="sidebar__filter-input" hidden value='400000' type="radio" id="price6"
                                        name="price">
                ...
                <div class="col-9">
                    <div class="sort-product">
                        <ul class="sort-product__list">
                            ...
                            <li data-sort='default' class="sort-product__item active">Mặc định <div class="underline">
                                </div>
                            </li>
                                        ...
                                        <div class="product__action">
                                            <div class="product__action-wrap">
                                                ...
                                                <div class="product__action-option">
                                                    <button onclick="handleLike.bind(this)()" data-id='${p.id}'
                                                        class="btn-action prouct__action-like">
                                                        <i class="far fa-heart"></i>
                                                    </button>
                                                    <button onclick="handleCart.bind(this)()" data-id='${p.id}'
                                                        class="btn-action product__action-cart">
        ...
        <script>
            ...
            fetch('/ATBM_CuoiKy/api-allproduct?type=category&id=' + pageConfig.categoryId + '&page=' + thisPage + '&sort=' + JSON.parse(localStorage.getItem('pageConfig')).sort
